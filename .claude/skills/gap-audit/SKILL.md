---
name: gap-audit
description: Weekly syllabus coverage audit — compares vault notes against the actual IB syllabus per subject and writes a Knowledge Gaps report to output/. Use for "audit my knowledge gaps".
---
